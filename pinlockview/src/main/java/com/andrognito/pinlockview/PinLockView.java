...
public class PinLockView extends RecyclerView {
    ...
    private PinLockAdapter.OnResetClickListener onResetClickListener=new PinLockAdapter.OnResetClickListener()
    {
        @Override
        public void onResetClicked()
        {

            mPinLockListener.onReset();
    ...
    private void initView() {
        ...
        mAdapter.setOnResetClickListener(onResetClickListener);
    ...
    /**
     * Sets a {@link PinLockListener} to the to listen to pin update eventsaaho
     *
     *
